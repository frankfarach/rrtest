...
# rrtest
[![Travis-CI Build Status](https://travis-ci.org/frankfarach/rrtest.svg?branch=master)](https://travis-ci.org/frankfarach/rrtest)
...
You can download the compendium as a zip from from this URL: <https://github.com/frankfarach/rrtest/archive/master.zip>

Or you can install this compendium as an R package, rrtest, from GitHub with:
